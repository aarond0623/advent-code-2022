...
This list represents the Calories of the food carried by the five Elves:
    ...
    - The fifth Elf is carrying one food with with 10000 Calories.
...
carrying the most Calories. In the above example, this is 24000 (carried by the
fourth Elf).
